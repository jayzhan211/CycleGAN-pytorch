...
class NICEGANModel(BaseModel):
    ...
    def __init__(self, opt):
        ...
        self.genA2B = NICE3SResnetGenerator(opt.input_nc, opt.output_nc, opt.ngf, opt.n_res).to(self.device)
        self.genB2A = NICE3SResnetGenerator(opt.output_nc, opt.input_nc, opt.ngf, opt.n_res).to(self.device)
