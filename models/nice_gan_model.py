...
from models.networks import UStyleGenerator, DiscriminatorUGATIT, NICEDiscriminator, NICEResnetGenerator
...
class NICEGANModel(BaseModel):
    ...
    def __init__(self, opt):
        ...
        self.genA2B = NICEResnetGenerator(opt.input_nc, opt.output_nc, opt.ngf, light=opt.light).to(self.device)
        self.genB2A = NICEResnetGenerator(opt.output_nc, opt.input_nc, opt.ngf,light=opt.light).to(self.device)
